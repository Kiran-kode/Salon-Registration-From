...
const ContactForm = () => {
    return (
        <>    
            <CommonHero title="Contact Us" imageUrl="https://media.istockphoto.com/id/1856117770/photo/modern-beauty-salon.jpg?s=612x612&w=0&k=20&c=dVZtsePk2pgbqDXwVkMm-yIw5imnZ2rnkAruR7zf8EA=" />
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 grid-cols-1 justify-between">
                    ...
                    <div class="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                        <h2 class="text-black font-manrope text-4xl font-semibold leading-10 mb-11">Send Us A Message</h2>
                        ...
                        <input type="text" class="w-full h-12 text-gray-600 placeholder-gray-400 shadow-sm bg-transparent text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none pl-4 " placeholder="Phone" />
                        <div class="mb-10" />
                        <input type="text" class="w-full h-12 text-gray-600 placeholder-gray-400 shadow-sm bg-transparent text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none pl-4 mb-10" placeholder="Message" />
                        <div class="mb-10" />

                        <button class="w-full h-12 text-white text-base font-semibold leading-6 rounded-full transition-all duration-700 hover:bg-white hover:text-black hover:border-cyan-700 bg-cyan-700 shadow-sm">Send</button>
                    </div>
                </div>
            </div>
        </section>
