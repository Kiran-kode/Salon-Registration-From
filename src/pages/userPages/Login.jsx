        ...
        <div style={{ animation: 'slideInFromLeft 1s ease-out' }} className="max-w-md w-full bg-gradient-to-r from-cyan-500 to-cyan-800 rounded-xl shadow-2xl overflow-hidden p-8 space-y-8">
          ...
          <form method="POST" action="#" className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <Link className="text-sm text-purple-200 hover:underline" to="#">Forgot your password?</Link>
            </div>
          ...
          <div className="text-center text-gray-300">
            New User?
              <Link to="/signup" className="text-purple-300 hover:underline">Register Here</Link>
          </div>
        </div>
        </div>
    </div>
